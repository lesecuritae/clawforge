...
declare -A paths=(
  ...
  [database_policy_engine_password]="${CLAWFORGE_DATABASE_POLICY_ENGINE_PASSWORD_SECRET_FILE:-./secrets/database_policy_engine_password}"
  [database_policy_engine_url]="${CLAWFORGE_DATABASE_POLICY_ENGINE_URL_SECRET_FILE:-./secrets/database_policy_engine_url}"
