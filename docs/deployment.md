...
Clawforge runs as API, worker, frontend, PostgreSQL, and scheduled backup Compose services. Redis is optional under the `cache` profile and is not required for correctness.
